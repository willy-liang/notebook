...
> - undefined是所有没有赋值变量的默认值，自动赋值；
> - null是主动释放一个变量引用的对象，表示一个变量不再指向任何对象地址
> - null和undefined共同点是都是原始类型，保存在栈中变量本地
> - **undefined表示变量声明但并未赋值**
> - null表示一个变量将来可能指向一个对象，**null一般用于主动释放对象的引用**
>
> **延伸——>垃圾回收机制**
>
...
> 浏览器的javascript引擎是单线程的，但浏览器本身是多线程的，浏览器包含
